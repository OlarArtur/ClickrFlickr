...
class CreateRequestAndGetResponse {
    ...
    static func concatenateBaseUrlString(urlString: String, parameters: [String]) -> String? {
    ...
    static func concatenateRequestUrlString(urlString: String, parameters: [String]) -> String {
